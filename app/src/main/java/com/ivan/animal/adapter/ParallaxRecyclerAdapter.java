package com.ivan.animal.adapter;
...
public abstract class ParallaxRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private static final String TAG = ParallaxRecyclerAdapter.class.getSimpleName();
    ...
    public static class VIEW_TYPES {
        ...
        public static final int FOOTER_VIEW = 4; //add by Ivan
    }
    ...
    public void setHasFooter(boolean flag){
        hasFooter = flag;
    }
    ...
    public int getItemViewType(int position) {
        ...
        return position == 0 ? VIEW_TYPES.HEADER : ((position+1 == getItemCount()) && hasFooter) ? VIEW_TYPES.FOOTER_VIEW : VIEW_TYPES.NORMAL;
    }
